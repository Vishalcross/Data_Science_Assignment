'''The objective of this assignement is to find the value of PI by approximating the area for a circle with the help of a two dimensional uniform distribution.'''
import scipy as sp
import numpy as np
